export const widgets = {
  ...
  confirmDelete: 'Are you sure you want to delete the widget',
  ...
  form: {
    ...
    publishDraftLabel: 'Publish this widget (remove draft status)',
    publishDraftHint: 'A draft widget does not appear in the dashboard add-widget panel.',
    tabs: {
      data: 'Data',
      style: 'Style',
      params: 'Parameters',
