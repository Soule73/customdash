...
export function WidgetPreview({ isLoading = false }: WidgetPreviewProps) {
    ...
    return (
      <Card className="flex h-full min-h-100 items-center justify-center">
        <div className="text-center">
          <Spinner size="lg" />
          <p className="mt-2 text-sm text-gray-500">Chargement des donnees...</p>
        </div>
      </Card>
    );
  }
    ...
    return (
      <Card className="flex h-full min-h-100 items-center justify-center">
        <div className="text-center text-gray-500 dark:text-gray-400">
          ...
          <p className="mt-4 text-sm">Configurez les metriques pour afficher l'apercu</p>
        </div>
      </Card>
    );
  }
  ...
  //           />
  //         </svg>
  //         <p className="mt-4 text-sm">Aucune donnee disponible</p>
  //       </div>
  //     </Card>
  //   );
  // }
  ...
  if (!WidgetComponent) {
    return (
      <div className="flex h-full items-center justify-center text-gray-500">
        Type de widget non supporte: {type}
      </div>
    );
  }
