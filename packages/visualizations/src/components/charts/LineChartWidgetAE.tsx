...
import { useLineChartVMAE } from '../../hooks/useLineChartVMAE';
...
/**
 * LineChartWidgetAE component rendering a line chart using Apache ECharts
 */
export function LineChartWidgetAE({
  data,
  config,
  widgetParams,
  height = 300,
...
export default LineChartWidgetAE;
